/*
* CODE GENERATED AUTOMATICALLY WITH github.com/ooni/psiphon/oopsi/github.com/stretchr/testify/_codegen
...
import (
	assert "github.com/ooni/psiphon/oopsi/github.com/stretchr/testify/assert"
	http "net/http"
	url "net/url"
	time "time"
)
