...
Package refraction wraps github.com/ooni/psiphon/oopsi/github.com/refraction-networking/gotapdance with
...
import (
	...
	"github.com/ooni/psiphon/oopsi/github.com/armon/go-proxyproto"
	lrucache "github.com/ooni/psiphon/oopsi/github.com/cognusion/go-cache-lru"
	refraction_networking_proto "github.com/ooni/psiphon/oopsi/github.com/refraction-networking/gotapdance/protobuf"
	refraction_networking_client "github.com/ooni/psiphon/oopsi/github.com/refraction-networking/gotapdance/tapdance"
)
...
func Listen(address string) (net.Listener, error) {
	...
	// https://godoc.org/github.com/ooni/psiphon/oopsi/github.com/armon/go-proxyproto#Conn.RemoteAddr
...
// are interrupted:
// E.g., https://github.com/ooni/psiphon/oopsi/github.com/refraction-networking/gotapdance/blob/4d84655dad2e242b0af0459c31f687b12085dcca/tapdance/conn_raw.go#L307
...
func (manager *dialManager) dialWithDialer(
	...
	if manager.useRunCtx {
		...
		// https://github.com/ooni/psiphon/oopsi/github.com/refraction-networking/gotapdance/blob/4d84655dad2e242b0af0459c31f687b12085dcca/tapdance/conn_raw.go#L263
