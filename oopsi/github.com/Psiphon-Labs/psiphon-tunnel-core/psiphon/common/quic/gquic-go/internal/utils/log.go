...
func readLoggingEnv() LogLevel {
	...
	default:
		fmt.Fprintln(os.Stderr, "invalid quic-go log level, see https://github.com/ooni/psiphon/oopsi/github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/common/quic/gquic-go/wiki/Logging")
		return LogLevelNothing
	}
}
