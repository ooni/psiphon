...
import (
	...
	"github.com/ooni/psiphon/oopsi/golang.org/x/sync/errgroup"
)
	...
	for _, g := range current {
		...
		if !found {
			...
			for i := 0; i < len(stack); i++ {
				...
				// https://github.com/ooni/psiphon/oopsi/github.com/golang/go/blob/release-branch.go1.13/src/testing/testing.go#L960-L961:
				//
				//     go tRunner(t, f)
				//     if !<-t.signal {
				//     ...
