...
import (
	...
	"github.com/ooni/psiphon/oopsi/github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/common/crypto/Yawning/chacha20"
...
func (p *PRNG) rekey() {
	...
	if err != nil {
		...
		// return an error. As of github.com/ooni/psiphon/oopsi/github.com/Yawning/chacha20 rev. e3b1f968,
...
func init() {
	...
	//
	// As of Go 1.9, with https://github.com/ooni/psiphon/oopsi/github.com/golang/go/issues/19274, on Linux
