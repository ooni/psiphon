...
import (
	...
	"github.com/ooni/psiphon/oopsi/github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/common/wildcard"
)
...
func CopyNBuffer(dst io.Writer, src io.Reader, n int64, buf []byte) (written int64, err error) {
	// Based on io.CopyN:
	// https://github.com/ooni/psiphon/oopsi/github.com/golang/go/blob/release-branch.go1.11/src/io/io.go#L339
