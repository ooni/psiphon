...
func getJSONRequestParam(apiParams common.APIParameters, name string, value interface{}) error {
	...
	// value as described here: https://github.com/ooni/psiphon/oopsi/golang.org/pkg/encoding/json/#Unmarshal.
...
func MakeSpeedTestResponse(minPadding, maxPadding int) ([]byte, error) {
	...
	// https://github.com/ooni/psiphon/oopsi/github.com/golang/go/blob/release-branch.go1.9/src/time/time.go#L1112
