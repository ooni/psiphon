...
This implementation is entirely based on and is a subset of Geneva:
  ...
  https://github.com/ooni/psiphon/oopsi/github.com/Kkevsterrr/geneva
...
func (t *transformationTCPFlags) apply(tcp *layers.TCP, _ *gopacket.Payload) {
	...
	if t.transformationType == transformationTypeRandom {
		...
		// https://github.com/ooni/psiphon/oopsi/github.com/Kkevsterrr/geneva/blob/de6823ba7723582054d2047083262cabffa85f36/layers/tcp_layer.py#L117-L121.
...
func (t *transformationTCPField) apply(tcp *layers.TCP, _ *gopacket.Payload) {
	...
	case tcpFieldDataOffset:
		...
		tcp.DataOffset &= 0x0f
	case tcpFieldWindow:
		// Differs from Geneva: https://github.com/ooni/psiphon/oopsi/github.com/Kkevsterrr/geneva/blob/de6823ba7723582054d2047083262cabffa85f36/layers/tcp_layer.py#L117-L121
...
func (t *transformationTCPPayload) apply(tcp *layers.TCP, payload *gopacket.Payload) {
	...
	case transformationTypeRandom:
		// Differs from Geneva: https://github.com/ooni/psiphon/oopsi/github.com/Kkevsterrr/geneva/blob/de6823ba7723582054d2047083262cabffa85f36/layers/layer.py#L191-L197
