...
import (
	...
	"github.com/ooni/psiphon/oopsi/github.com/grafov/m3u8"
)
...
//
// https://github.com/ooni/psiphon/oopsi/github.com/justmao945/mallory
// Copyright (c) 2014 JianjunMao
// The MIT License (MIT)
//
// https://github.com/ooni/psiphon/oopsi/golang.org/src/pkg/net/http/httputil/reverseproxy.go
...
// From https://github.com/ooni/psiphon/oopsi/golang.org/src/pkg/net/http/httputil/reverseproxy.go:
...
func proxifyURL(localHTTPProxyIP string, localHTTPProxyPort int, urlString string, rewriteParams []string) string {
	...
	// Note that we need to use the "opaque" form of URL so that it doesn't double-escape the path. See: https://github.com/ooni/psiphon/oopsi/github.com/golang/go/issues/10887
