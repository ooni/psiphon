...
import (
	...
	"github.com/ooni/psiphon/oopsi/github.com/Psiphon-Labs/net/http2"
	...
	"github.com/ooni/psiphon/oopsi/github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/upstreamproxy"
	"github.com/ooni/psiphon/oopsi/golang.org/x/crypto/nacl/box"
)
...
func DialMeek(
	...
	if meekConfig.UseQUIC {
		...
		// e.g., https://github.com/ooni/psiphon/oopsi/github.com/golang/go/blob/c8aec4095e089ff6ac50d18e97c3f46561f14f48/src/net/http/transport.go#L1040
		//
		...
		// (yet; as of Go 1.9 this issue is still open: https://github.com/ooni/psiphon/oopsi/github.com/golang/go/issues/21526),
...
// See: https://github.com/ooni/psiphon/oopsi/golang.org/pkg/net/http/#RoundTripper
...
func (meek *MeekConn) addAdditionalHeaders(request *http.Request) {
	for name, value := range meek.additionalHeaders {
		...
		// https://github.com/ooni/psiphon/oopsi/golang.org/src/net/http/request.go#L474
		// using URL.Opaque, see URL.RequestURI() https://github.com/ooni/psiphon/oopsi/golang.org/src/net/url/url.go#L915
		if name == "Host" {
			if len(value) > 0 {
