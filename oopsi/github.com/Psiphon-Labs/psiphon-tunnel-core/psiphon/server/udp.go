...
// https://github.com/ooni/psiphon/oopsi/github.com/ambrop72/badvpn
//
...
func (mux *udpPortForwardMultiplexer) run() {
	...
	for {
		...
		// Note: assumes UDP writes won't block (https://github.com/ooni/psiphon/oopsi/golang.org/pkg/net/#UDPConn.WriteToUDP)
...
func (portForward *udpPortForward) relayDownstream() {
	...
	for {
		...
		if err == nil {
			...
			// See: https://github.com/ooni/psiphon/oopsi/github.com/Psiphon-Inc/crypto/blob/82d98b4c7c05e81f92545f6fddb45d4541e6da00/ssh/channel.go#L272,
