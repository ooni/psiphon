...
import (
	...
	"github.com/ooni/psiphon/oopsi/github.com/Psiphon-Inc/rotate-safe-writer"
	"github.com/ooni/psiphon/oopsi/github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/common"
	"github.com/ooni/psiphon/oopsi/github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/common/buildinfo"
	"github.com/ooni/psiphon/oopsi/github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/common/errors"
	"github.com/ooni/psiphon/oopsi/github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/common/stacktrace"
	"github.com/ooni/psiphon/oopsi/github.com/sirupsen/logrus"
)
...
// https://github.com/ooni/psiphon/oopsi/github.com/Sirupsen/logrus/blob/f1addc29722ba9f7651bc42b4198d0944b66e7c4/json_formatter.go
//
// The changes are:
...
func (f *CustomJSONFormatter) Format(entry *logrus.Entry) ([]byte, error) {
	...
	for k, v := range entry.Data {
		...
		case error:
			...
			// https://github.com/ooni/psiphon/oopsi/github.com/Sirupsen/logrus/issues/137
			data[k] = v.Error()
		default:
			data[k] = v
		}
