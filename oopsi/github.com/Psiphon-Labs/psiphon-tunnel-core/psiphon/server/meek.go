...
import (
	...
	tris "github.com/ooni/psiphon/oopsi/github.com/Psiphon-Labs/tls-tris"
...
func (server *MeekServer) Run() error {
	...
	httpServer := &http.Server{
		...
		// Disable auto HTTP/2 (https://github.com/ooni/psiphon/oopsi/golang.org/doc/go1.6)
...
func (server *MeekServer) makeMeekTLSConfig(
	...
	if isFronted {
		...
		// https://github.com/ooni/psiphon/oopsi/github.com/golang/go/blob/1cb3044c9fcd88e1557eca1bf35845a4108bc1db/src/crypto/tls/cipher_suites.go#L75
		//
