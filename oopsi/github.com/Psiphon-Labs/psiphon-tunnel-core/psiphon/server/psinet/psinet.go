...
func bucketizeServerList(servers []*DiscoveryServer, bucketCount int) [][]*DiscoveryServer {
	...
	// https://github.com/ooni/psiphon/oopsi/github.com/Psiphon-Inc/psiphon-automation/blob/685f91a85bcdb33a75a200d936eadcb0686eadd7/Automation/psi_ops_discovery.py
	//
