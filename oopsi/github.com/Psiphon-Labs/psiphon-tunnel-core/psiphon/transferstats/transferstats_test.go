...
import (
	...
	mapset "github.com/ooni/psiphon/oopsi/github.com/deckarep/golang-set"
	"github.com/ooni/psiphon/oopsi/github.com/stretchr/testify/suite"
)
...
func (suite *StatsTestSuite) Test_getTLSHostname() {
	...
	// https://github.com/ooni/psiphon/oopsi/github.com/golang/go/blob/master/src/crypto/tls/handshake_messages.go
