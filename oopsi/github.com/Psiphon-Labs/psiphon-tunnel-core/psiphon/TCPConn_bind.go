...
import (
	...
	"github.com/ooni/psiphon/oopsi/github.com/creack/goselect"
)
...
// https://github.com/ooni/psiphon/oopsi/github.com/golang/go/issues/6966
// (originally: https://code.google.com/p/go/issues/detail?id=6966)
//
// TODO: use https://github.com/ooni/psiphon/oopsi/golang.org/pkg/net/#Dialer.Control, introduced in Go 1.11?
func tcpDial(ctx context.Context, addr string, config *DialConfig) (net.Conn, error) {
	...
	for _, index := range permutedIndexes {
		...
		// unexpectedly returns nil: https://github.com/ooni/psiphon/oopsi/github.com/golang/go/issues/23022.
		//
