...
*/
package trace // import "github.com/ooni/psiphon/oopsi/golang.org/x/net/trace"
...
import (
	...
	"github.com/ooni/psiphon/oopsi/golang.org/x/net/internal/timeseries"
)
...
func init() {
	...
	if pat != "" {
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"github.com/ooni/psiphon/oopsi/golang.org/x/net/trace in your binary, trying to maintain separate state. This may " +
			"involve a vendored copy of github.com/ooni/psiphon/oopsi/golang.org/x/net/trace.")
	}
...
var contextKey = contextKeyT("github.com/ooni/psiphon/oopsi/golang.org/x/net/trace.Trace")
