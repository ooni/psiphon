...
type Config struct {
	...
	// https://github.com/ooni/psiphon/tunnel-core/tree/master/psiphon/upstreamproxy
...
func (n *loggingNetworkIDGetter) GetNetworkID() string {
	...
	// See: https://godoc.org/github.com/ooni/psiphon/tunnel-core/psiphon#NetworkIDGetter
