...
*/
// -X github.com/ooni/psiphon/tunnel-core/psiphon/common/buildinfo.buildDate=`date --iso-8601=seconds`
var buildDate string

// -X github.com/ooni/psiphon/tunnel-core/psiphon/common/buildinfo.buildRepo=`git config --get remote.origin.url`
var buildRepo string

// -X github.com/ooni/psiphon/tunnel-core/psiphon/common/buildinfo.buildRev=`git rev-parse --short HEAD`
var buildRev string

// -X github.com/ooni/psiphon/tunnel-core/psiphon/common/buildinfo.goVersion=`go version | perl -ne '/go version (.*?) / && print $1'`
var goVersion string

// -X github.com/ooni/psiphon/tunnel-core/psiphon/common/buildinfo.gomobileVersion=`gomobile version | perl -ne '/gomobile version (.*?) / && print $1'`
var gomobileVersion string

// -X github.com/ooni/psiphon/tunnel-core/common/buildinfo.dependencies=`echo -n "{" && go list -f '{{range $dep := .Deps}}{{printf "%s\n" $dep}}{{end}}' | xargs go list -f '{{if not .Standard}}{{.ImportPath}}{{end}}' | xargs -I pkg bash -c 'cd $GOPATH/src/pkg && echo -n "\"pkg\":\"$(git rev-parse --short HEAD)\","' | sed 's/,$/}/'`
// Dependencies should be listed as a JSON object like the following (no spaces) {"github.com/ooni/psiphon/tunnel-core":"abcdef","...":"..."}
